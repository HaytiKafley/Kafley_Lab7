...
public class RPSLSpock {
    ...
    /**
     *
     * @param pick: User can pick any value when the string value is passed by the user
     * @return once the user picked the following value "rock, paper, scissors, lizard, spock" boolean value will return true; or else program ignored
     */
    ...
    /**
     *
     * @return from 0 to 4, system will generate any random number.
     */
    ...
    /**
     *
     * @param c_pick: program generate pick
     * @param h_pick: choices are picked by the user
